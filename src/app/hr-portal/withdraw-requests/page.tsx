...
import hrMockDataInstance, { WithdrawRequest } from "@/lib/hrPortalMockData";
...
export default function WithdrawRequestsPage() {
    ...
    const loadData = () => {
      try {
        setTimeout(() => {
          ...
          const requestData = hrMockDataInstance.withdrawRequests || [];
          setWithdrawRequests(requestData);
          setIsLoading(false);
  ...
  // Filter withdraw requests based on search term and status
    ...
    <div>
          ...
          <div className="flex justify-between h-16">
            ...
            <div className="hidden md:flex md:items-center md:space-x-6">
              ...
              <Link href="/hr-portal/withdraw-requests">
                <Button variant="default" className="text-sm">Withdraw Requests</Button>
              </Link>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-gray-500 mt-1">View and manage employee withdrawal requests</p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <Card className="p-4 shadow">
            ...
            <p className="text-2xl font-bold mt-1">{withdrawRequests.length}</p>
          </Card>
          ...
          <Card className="p-4 shadow">
            <p className="text-sm font-medium text-gray-500">Total Withdrawn Amount</p>
            <p className="text-2xl font-bold mt-1">
              MMK {withdrawRequests
