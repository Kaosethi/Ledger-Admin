...
import { useReactToPrint, UseReactToPrintOptions } from "react-to-print"; // Import print hook
...
const EditAccountModal: React.FC<EditAccountModalProps> = ({
  ...
  const handleToggleStatus = () => {
    ...
    const newStatus: Account["status"] =
      account.status === "Active" ? "Suspended" : "Active"; // Toggle between Active and Suspended
  ...
  const handleRegenerateQr = () => {
    ...
    alert(
      "QR Code regenerated (simulated). In a real app, update relevant backend data if needed."
    );
