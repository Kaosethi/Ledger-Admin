    ...
    <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {logs.length === 0 ? (
              ...
              logs
                ...
                .map(
                  (
                    log: AdminLog // Create copy and reverse for display order
                  ) => (
                    <tr key={log.id}>
                      ...
                      <td className="table-cell break-words max-w-xs">
                        {log.details}
                      </td>
      ...
      <div className="flex items-center justify-between mt-6 pt-4 border-t border-gray-200">
        <div className="text-sm text-gray-700">
          ...
          Showing <span id="log-pagination-start">1</span> to{" "}
          <span id="log-pagination-end">{Math.min(10, logs.length)}</span> of{" "}
          <span id="log-pagination-total">{logs.length}</span> logs
        </div>
