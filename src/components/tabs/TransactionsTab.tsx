        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <thead className="bg-gray-50">
            <tr>
              ...
              <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"> Merchant Name </th> {/* ADDED */}
              <th scope="col" className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"> Merchant ID </th>
              ...
              <th scope="col" className="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider"> Amount </th> {/* ADDED */}
              ...
              filteredTransactions.map((transaction: Transaction) => {
                ...
                return (
                  <tr key={transaction.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{merchantName}</td> {/* ADDED */}
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700 font-mono">{transaction.merchantId}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700">{transaction.accountId}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">{transaction.id}</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-700 text-center">{formatCurrency(transaction.amount)}</td> {/* ADDED */}
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-center actions">
                      <button className="text-primary hover:text-secondary view-transaction-btn focus:outline-none focus:underline" onClick={() => handleViewDetailsClick(transaction)} > Details </button>
                    </td>
                  </tr>
                );
              })
