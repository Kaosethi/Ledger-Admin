...
export interface Account {
  ...
  currentQrToken?: string; // Same as qrCode but matching database field name
  guardianDob?: string;
...
const mockDataInstance: AppData = {
  ...
  accounts: [
    {
      ...
      currentQrToken:
        "eyJ0eXBlIjoicGF5IiwiYWNjb3VudCI6IkFDQy0wMDEiLCJ2ZXIiOiIxLjAiLCJzaWciOiJhYmMxMjMifQ==",
    ...
    },
    {
      ...
      currentQrToken:
        "eyJ0eXBlIjoicGF5IiwiYWNjb3VudCI6IkFDQy0wMDIiLCJ2ZXIiOiIxLjAiLCJzaWciOiJhYmM1Njc4In0=",
    ...
    },
    {
      ...
      currentQrToken:
        "eyJ0eXBlIjoicGF5IiwiYWNjb3VudCI6IkFDQy0wMDMiLCJ2ZXIiOiIxLjAiLCJzaWciOiJhYmM5MDEyIn0=",
    ...
    },
    {
      ...
      lastActivity: "2024-03-09T10:30:00Z",
      updatedAt: "2023-04-10T08:15:00Z",
      pin: "3456",
      qrCodeUrl: generateMockQrCodeUrl("ACC-004"),
      currentQrToken:
        "eyJ0eXBlIjoicGF5IiwiYWNjb3VudCI6IkFDQy0wMDQiLCJ2ZXIiOiIxLjAiLCJzaWciOiJhYmMzNDU2In0=",
      guardianDob: "1975-03-08",
      guardianContact: "555-3456",
      address: "101 Themyscira Ave, Paradise Island",
    },
    {
      id: "ACC-005",
      displayId: "ACC-005",
      ...
      lastActivity: "2023-10-01T09:15:00Z",
      updatedAt: "2023-10-01T09:15:00Z",
      pin: "7890",
      qrCodeUrl: generateMockQrCodeUrl("ACC-005"),
      currentQrToken:
        "eyJ0eXBlIjoicGF5IiwiYWNjb3VudCI6IkFDQy0wMDUiLCJ2ZXIiOiIxLjAiLCJzaWciOiJhYmM3ODkwIn0=",
      guardianDob: "1982-07-18",
      guardianContact: "555-7890",
      address: "42 Mars Colony, Red Planet",
    },
  ],
  merchants: [
    {
      ...
      category: "Groceries",
      status: "Active",
      submittedAt: "2022-11-01T00:00:00Z",
  ...
  adminActivityLog: [
    ...
    },
    {
      ...
      targetType: "Account",
      targetId: "ACC-001",
      details: "Accessed details page for Alice Wonderland.",
    },
    {
      id: uuidv4(),
      ...
      targetType: "Merchant",
      targetId: "MER-P01",
      details: "Approved merchant: New Book Nook",
    },
    {
      id: uuidv4(),
      timestamp: getDateString(0),
      ...
      targetId: "MER-002",
      details:
        "Suspended merchant: School Supply Station due to terms violation.",
    },
    {
      id: uuidv4(),
      timestamp: getDateString(0),
      ...
      targetId: "PEN-1700000000000-abc12",
      details:
        "Rejected registration for Fiona Shrek: Incomplete documentation.",
    },
    {
      id: uuidv4(),
      timestamp: getDateString(0),
      adminUsername: "admin@example.com",
      action: "Updated Account Balance",
      targetType: "Account",
      targetId: "ACC-002",
      details: "Manually adjusted balance for Bob The Builder by +$50.00.",
    },
    {
      id: uuidv4(),
      timestamp: getDateString(0),
      adminUsername: "supervisor@example.com",
      action: "Reactivated Merchant",
      targetType: "Merchant",
      targetId: "MER-005",
      details: "Reactivated merchant: Old Tech Shop after review.",
    },
    {
      id: uuidv4(),
      timestamp: getDateString(0),
      adminUsername: "admin@example.com",
      action: "Performed Transaction Adjustment",
    ...
    },
    {
      ...
      targetId: "ACC-005",
      details:
        "Changed status from Active to Suspended due to policy violation.",
    },
    {
      id: uuidv4(),
      timestamp: getDateString(0),
      adminUsername: "admin@example.com",
      action: "Viewed Merchant Details",
      targetType: "Merchant",
      targetId: "MER-001",
      details: "Viewed details for General Groceries.",
    },
    {
      id: uuidv4(),
      timestamp: getDateString(0),
      ...
      targetType: "Registration",
      targetId: "PEN-1710000000000-def34",
      details: "Approved registration for สมชาย ใจดี. New account created.",
    },
    {
      id: uuidv4(),
      timestamp: getDateString(0),
    ...
    },
    {
      ...
      targetType: "System",
      details: "Incorrect password entered for supervisor@example.com",
    },
  ].sort(
    (a, b) => new Date(b.timestamp).getTime() - new Date(a.timestamp).getTime()
  ) as AdminLog[], // Assert type here after sort
  pendingRegistrations: [
    ...
    },
    {
      ...
      displayId: "PEN-1710000000000-def34",
