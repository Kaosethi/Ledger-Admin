...
export const formatDateTime = (
    ...
    try {
        ...
        const timeOptions: Intl.DateTimeFormatOptions = { hour: '2-digit', minute: '2-digit', /* hour12: true */ }; // Optional: Use 12-hour clock
    ...
    switch (type) {
        ...
        case 'merchant':
             switch (lowerCaseStatus) {
                ...
                case 'pending': bgColor = 'bg-blue-100'; textColor = 'text-blue-800'; break; // Changed from pending_approval
                 case 'suspended': bgColor = 'bg-yellow-100'; textColor = 'text-yellow-800'; break;
        ...
        case 'transaction':
             switch (lowerCaseStatus) {
                ...
                case 'declined': bgColor = 'bg-red-100'; textColor = 'text-red-800'; break; // Same as failed for now
            }
            break;
        case 'pending': // Generic pending registration/request status
             switch (lowerCaseStatus) {
                case 'pending': bgColor = 'bg-blue-100'; textColor = 'text-blue-800'; break;
                case 'approved': bgColor = 'bg-green-100'; textColor = 'text-green-800'; break;
                 case 'rejected': bgColor = 'bg-red-100'; textColor = 'text-red-800'; break;
            }
            break;
        default: // Fallback
